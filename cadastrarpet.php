...
<head>
	...
	<title>Cadastrar Pet &#8211; Pick Pet</title>
...
<script type='text/javascript'>
	window.addEventListener( 'DOMContentLoaded', function() {
		rltInitialize( {"token":"rlt-","iframeOrigins":["https:\/\/widgets.wp.com"]} );
	} );
</script>
...
<link rel="canonical" href="https://pickpet171.wordpress.com/cadastrar-pet/" />
<link rel='shortlink' href='https://wp.me/PdDkjx-39' />
		...
		<link rel="alternate" type="application/json+oembed" href="https://public-api.wordpress.com/oembed/?format=json&amp;url=https%3A%2F%2Fpickpet171.wordpress.com%2Fcadastrar-pet%2F&amp;for=wpcom-auto-discovery" /><link rel="alternate" type="application/xml+oembed" href="https://public-api.wordpress.com/oembed/?format=xml&amp;url=https%3A%2F%2Fpickpet171.wordpress.com%2Fcadastrar-pet%2F&amp;for=wpcom-auto-discovery" />
<!-- Jetpack Open Graph Tags -->
<meta property="og:type" content="article" />
<meta property="og:title" content="Cadastrar Pet" />
<meta property="og:url" content="https://pickpet171.wordpress.com/cadastrar-pet/" />
<meta property="og:description" content="Visite o post para mais." />
<meta property="article:published_time" content="2022-01-07T00:56:45+00:00" />
<meta property="article:modified_time" content="2022-01-10T23:00:20+00:00" />
...
<meta name="twitter:text:title" content="Cadastrar Pet" />
...
<meta name="application-name" content="Pick Pet" /><meta name="msapplication-window" content="width=device-width;height=device-height" /><meta name="msapplication-tooltip" content="Adoção e Divulgação" /><meta name="msapplication-task" content="name=Editar página;action-uri=https://wordpress.com/page/pickpet171.wordpress.com/195;icon-uri=https://s0.wp.com/i/icons/page.ico" /><meta name="msapplication-task" content="name=Escrever um post;action-uri=https://wordpress.com/post/pickpet171.wordpress.com;icon-uri=https://s0.wp.com/i/icons/post.ico" /><meta name="msapplication-task" content="name=Moderar comentários;action-uri=https://pickpet171.wordpress.com/wp-admin/edit-comments.php?comment_status=moderated;icon-uri=https://s0.wp.com/i/icons/comment.ico" /><meta name="msapplication-task" content="name=Fazer upload de nova mídia;action-uri=https://pickpet171.wordpress.com/wp-admin/media-new.php;icon-uri=https://s0.wp.com/i/icons/media.ico" /><meta name="msapplication-task" content="name=Estatística do blog;action-uri=https://pickpet171.wordpress.com/wp-admin/index.php?page=stats;icon-uri=https://s0.wp.com/i/icons/stats.ico" /><!-- Não existe versão amphtml disponível para essa URL. --><style type="text/css" media="print">#wpadminbar { display:none; }</style>
...
<body class="page-template-default page page-id-195 logged-in admin-bar no-customize-support wp-custom-logo wp-embed-responsive customizer-styles-applied singular image-filters-enabled hide-homepage-title  highlander-enabled highlander-light">
...
<h1 class="entry-title">Cadastrar Pet</h1>
	</header>
...
<div class="wp-block-column"><div id='contact-form-195'>
...
<?php
        ...
        ?>
        <form action="processa_cadastrarpet.php" method="post" enctype="multipart/form-data">
            ...
            <br><label><b>Nome Completo </b> (Responsável) </label> <br>
            <input type="text" required name="responsavel" size = "85"> <br>

            <br><label><b>CPF</b> (EX: 123.456.678-09) </label> <br>
            <input type="text" required name="cpf" size = "85"> <br>
            
            <br><label><b>RG</b> (EX: 12.345.667-8) </label> <br>
            <input type="text" required name="rg" size = "85"> <br>
            
	    <br><label><b>Idade</b> (Responsável) </label> <br>
            <input type="text" required name="idade" size = "85"> <br>
            
            <br><label><b>Sexo</b> (Responsável) </label> <br>
            <input type="radio" name="sexo" value = "Masculino"> Masculino <br>
            <input type="radio" name="sexo" value = "Feminino"> Feminino <br>
            
            <br><label><b>E-mail</b>  </label> <br>
            <input type="email" required name="email" size = "85"> <br>
            
            <br><label><b>Número de telefone</b> (Ex: (22) 123456789) </label> <br>
            <input type="text" required name="tel1" size = "85"> <br>
            
            <br><label><b>Outro Número de telefone</b> (Ex: (22) 123456789) </label> <br>
            <input type="text" required name="tel2" size = "85"> <br>
  
            <br><label><b>Endereço</b>  </label> <br>
            <input type="text" required name="endereco" size = "85"> <br>
            
            <br><label><b>Número</b>  </label> <br>
            <input type="text" required name="numero" size = "85"> <br>
            
            <br><label><b>Complemento</b>  </label> <br>
            <input type="text" required name="complemento" size = "85"> <br>
            
            <br><label><b>Bairro</b>  </label> <br>
            <input type="text" required name="bairro" size = "85"> <br>
            
            <br><label><b>Cidade</b>  </label> <br>
            <input type="text" required name="cidade" size = "85"> <br>
            ...
            <br><br> <label><b>CEP</b> (EX: 12345678) </label> <br>
            <input type="text" required name="cep" size = "85"> <br>
			
			<br><br> <h3> Sobre o Pet: </h3> 
            <h5> _________________ </h5>  
			
			<br><label><b>Nome do Pet</b> </label> <br>
            <input type="text" required name="nomepet" size = "85"> <br>
			
            <br><label><b>O Pet cadastrado é:</b>   <label> <br>
            <input type="radio" name="pet" value = "Cachorro"> Cachorro <br>
            <input type="radio" name="pet" value = "Gatinho"> Gatinho <br>
            
            <br><label><b>Raça</b>  </label> <br>
            <input type="text" required name="raca" size = "85"> <br>
            
            <br><label><b>Sexo do Pet</b>  </label> <br>
            <input type="radio" name="sexopet" value = "Macho"> Macho <br>
            <input type="radio" name="sexopet" value = "Fêmea"> Fêmea <br>
            
            <br><label><b>Idade aproximada do Pet</b>  </label> <br>
            <input type="text" required name="idadepet" size = "85"> <br>
            
            <br><label><b>Descrição</b>  </label> <br>
            <input type="text" required name="descricao" size = "85"> <br>
...
var wpcom_tos_report_form = {"ajaxurl":"\/wp-admin\/admin-ajax.php","isLoggedoutUser":"","post_ID":"195","current_url":"https:\/\/pickpet171.wordpress.com\/cadastrar-pet","report_this_content":"Denunciar este conte\u00fado"};
</script>
...
_stq.push(['view', {'blog':'201465251','v':'wpcom','tz':'-3','user':'1','user_id':'192746555','post':'195','subd':'pickpet171'}]);
_stq.push(['extra', {'crypt':''}]);
	</script>
