...
<head>
	...
	<title>Formulário &#8211; Pick Pet</title>
...
<script type='text/javascript'>
	window.addEventListener( 'DOMContentLoaded', function() {
		rltInitialize( {"token":"rlt-","iframeOrigins":["https:\/\/widgets.wp.com"]} );
	} );
</script>
...
<link rel="canonical" href="https://pickpet171.wordpress.com/formulario/" />
<link rel='shortlink' href='https://wp.me/PdDkjx-31' />
		...
		<link rel="alternate" type="application/json+oembed" href="https://public-api.wordpress.com/oembed/?format=json&amp;url=https%3A%2F%2Fpickpet171.wordpress.com%2Fformulario%2F&amp;for=wpcom-auto-discovery" /><link rel="alternate" type="application/xml+oembed" href="https://public-api.wordpress.com/oembed/?format=xml&amp;url=https%3A%2F%2Fpickpet171.wordpress.com%2Fformulario%2F&amp;for=wpcom-auto-discovery" />
<!-- Jetpack Open Graph Tags -->
<meta property="og:type" content="article" />
<meta property="og:title" content="Formulário" />
<meta property="og:url" content="https://pickpet171.wordpress.com/formulario/" />
<meta property="og:description" content="Click on the &#8220;Choose File&#8221; button to upload a file:" />
<meta property="article:published_time" content="2022-01-07T00:56:51+00:00" />
<meta property="article:modified_time" content="2022-01-10T23:18:39+00:00" />
...
<meta name="twitter:text:title" content="Formulário" />
...
<meta name="application-name" content="Pick Pet" /><meta name="msapplication-window" content="width=device-width;height=device-height" /><meta name="msapplication-tooltip" content="Adoção e Divulgação" /><meta name="msapplication-task" content="name=Editar página;action-uri=https://wordpress.com/page/pickpet171.wordpress.com/187;icon-uri=https://s0.wp.com/i/icons/page.ico" /><meta name="msapplication-task" content="name=Escrever um post;action-uri=https://wordpress.com/post/pickpet171.wordpress.com;icon-uri=https://s0.wp.com/i/icons/post.ico" /><meta name="msapplication-task" content="name=Moderar comentários;action-uri=https://pickpet171.wordpress.com/wp-admin/edit-comments.php?comment_status=moderated;icon-uri=https://s0.wp.com/i/icons/comment.ico" /><meta name="msapplication-task" content="name=Fazer upload de nova mídia;action-uri=https://pickpet171.wordpress.com/wp-admin/media-new.php;icon-uri=https://s0.wp.com/i/icons/media.ico" /><meta name="msapplication-task" content="name=Estatística do blog;action-uri=https://pickpet171.wordpress.com/wp-admin/index.php?page=stats;icon-uri=https://s0.wp.com/i/icons/stats.ico" /><meta name="description" content="Click on the &quot;Choose File&quot; button to upload a file:" />
...
<body class="page-template-default page page-id-187 logged-in admin-bar no-customize-support wp-custom-logo wp-embed-responsive customizer-styles-applied singular image-filters-enabled hide-homepage-title  highlander-enabled highlander-light">
...
<h1 class="entry-title">Formulário</h1>
	</header>
...
<div class="wp-block-column"><div id='contact-form-187'>

	<?php 		$query = "SELECT * FROM pet WHERE id='$id'";  
            $result = mysqli_query($conn, $query);  
			while($rows_pet = mysqli_fetch_assoc($resultado_pet) ){ }?>	
			
<form  action="processa_adotar.php?id=<?php echo $id; ?>" method='post' enctype="multipart/form-data" class='contact-form commentsblock wp-block-jetpack-contact-form'>
<script>
			( function () {
...
<label
				...
				>CPF<span>(EX: 123.456.678-09)</span></label>
<input
					type='text'
					name='cpf'
					id='cpf'
...
<label
				for='rg'
				class='grunion-field-label text'
				>RG<span>(EX: 12.345.667-8)</span></label>
<input
					type='text'
					name='rg'
					id='rg'
...
<label
		...
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='sexo'
									value='Feminino' class='radio'  required aria-required='true'/> Feminino</label>
		<div class='clear-form'></div>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='sexo'
									value='Masculino' class='radio'  required aria-required='true'/> Masculino</label>
		<div class='clear-form'></div>
	</div>
...
<label
				...
				>Número de telefone<span>(Ex: (22) 123456789)</span></label>
<input
					type='tel'
					name='tel1'
					id='tel1'
...
<div class='grunion-field-wrap grunion-field-telephone-wrap'  >
<label
				for='g187-outronmerodotelefone'
				class='grunion-field-label telephone'
				>Outro Número de telefone<span>(Ex: (22) 123456789)</span></label>
<input
					type='tel'
					name='tel2'
					id='g187-outronmerodotelefone'
					value=''
					class='telephone' 
...
<label
				for='contact-form-comment-g187-porquequeroadotarumpet'
				class='grunion-field-label textarea'
				>Porque quero adotar um Pet?</label>
<textarea
		                name='porque'
		                id='contact-form-comment-g187-porquequeroadotarumpet'
...
<div class='grunion-field-wrap grunion-field-radio-wrap'  >
<label
				for='g187-possuioujpossuiuumpet'
				class='grunion-field-label'
				>Tem ou já Teve um Pet?</label>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='jateve'
									value='Sim, tenho Pets' class='radio'  required aria-required='true'/> Sim, tenho Pets</label>
		<div class='clear-form'></div>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='jateve'
									value='Sim, ja possui mas nao tenho mais' class='radio'  required aria-required='true'/> Sim, já tive mas não tenho mais</label>
		<div class='clear-form'></div>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='jateve'
									value='Nao possuo Pets' class='radio'  required aria-required='true'/> Não possuo Pets</label>
		<div class='clear-form'></div>
	</div>
...
<div class='grunion-field-wrap grunion-field-text-wrap'  >
<label
				for='g187-casoafirmativo044citequaispetstemoujtevequantidade'
				class='grunion-field-label text'
				>Caso afirmativo&#044; cite quais Pets tem ou já teve + quantidade</label>
<input
					type='text'
					name='qnt'
					id='g187-casoafirmativo044citequaispetstemoujtevequantidade'
					value=''
					class='text' 
...
<div class='grunion-field-wrap grunion-field-radio-wrap'  >
<label
				for='g187-algumdesuacasaalrgicoagatooucachorro'
				class='grunion-field-label'
				>Alguém de sua casa é alérgico a Gato ou Cachorro?</label>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='alergia'
									value='Sim' class='radio'  required aria-required='true'/> Sim</label>
		<div class='clear-form'></div>
		<label class='grunion-radio-label radio'><input
									type='radio'
									name='alergia'
									value='Nao' class='radio'  required aria-required='true'/> Não</label>
		<div class='clear-form'></div>
	</div>
...
<div class='grunion-field-wrap grunion-field-textarea-wrap'  >
<label
				for='contact-form-comment-g187-oquefarcasonopossamaiscuidardopet'
				class='grunion-field-label textarea'
				>O que fará caso não possa mais cuidar do Pet?</label>
<textarea
		                name='cuidar'
		                id='contact-form-comment-g187-oquefarcasonopossamaiscuidardopet'
		                rows='20' class='textarea'  required aria-required='true'></textarea>
	</div>
...
<div class="wp-block-jetpack-button is-style-outline wp-block-button" style=""><button class="wp-block-button__link is-style-outline has-text-color has-background-color has-background has-secondary-background-color" style="border-radius: 12px;" data-id-attr="placeholder" type="submit">Enviar</button></div>
</form>
</div></div>
</div>
	</div><!-- .entry-content -->
...
var wpcom_tos_report_form = {"ajaxurl":"\/wp-admin\/admin-ajax.php","isLoggedoutUser":"","post_ID":"187","current_url":"https:\/\/pickpet171.wordpress.com\/formulario","report_this_content":"Denunciar este conte\u00fado"};
</script>
...
_stq.push(['view', {'blog':'201465251','v':'wpcom','tz':'-3','user':'1','user_id':'192746555','post':'187','subd':'pickpet171'}]);
_stq.push(['extra', {'crypt':''}]);
	</script>
<noscript><img src="https://pixel.wp.com/b.gif?v=noscript" style="height:1px;width:1px;overflow:hidden;position:absolute;bottom:1px;" alt="" /></noscript>
<script defer id="bilmur" data-customproperties="{&quot;enq_backbone&quot;:&quot;1&quot;,&quot;enq_jquery&quot;:&quot;1&quot;,&quot;enq_mustache&quot;:&quot;1&quot;,&quot;enq_underscore&quot;:&quot;1&quot;,&quot;logged_in&quot;:&quot;1&quot;}" data-provider="wordpress.com" data-service="simple" src="/wp-content/js/bilmur.min.js?i=3&m=202202"></script><script>
